        ...
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          ...
          <div className="legal-body">
            ...
            <section>
              ...
              <p>
                Al acceder y utilizar la plataforma <strong>Pavas Marketplace</strong> (en adelante, "la Plataforma"), aceptas quedar vinculado por estos Términos y condiciones. Si no estás de acuerdo con alguna de las disposiciones aquí contenidas, debes abstenerte de usar la Plataforma.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Pavas Marketplace se reserva el derecho de eliminar cualquier anuncio que incumpla estas condiciones sin previo aviso ni reembolso.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Todo el contenido de la Plataforma (diseño, código, marca, textos e imágenes propias de Pavas Marketplace) es propiedad exclusiva de Pavas Marketplace y está protegido por las leyes de propiedad intelectual aplicables. Los usuarios conservan los derechos sobre el contenido que publican, pero otorgan a Pavas Marketplace una licencia no exclusiva para mostrarlo, indexarlo y distribuirlo dentro de la Plataforma.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Pavas Marketplace no se hace responsable de:</p>
              <ul>
            ...
            <section>
              ...
              <p>
                Pavas Marketplace podrá suspender o cancelar una cuenta, de forma temporal o definitiva, si detecta incumplimiento de estos términos, actividad fraudulenta o cualquier conducta que ponga en riesgo la integridad de la Plataforma o de otros usuarios.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Pavas Marketplace se reserva el derecho de actualizar estos Términos en cualquier momento. Los cambios sustanciales serán notificados a los usuarios registrados. El uso continuado de la Plataforma tras la publicación de los cambios constituye aceptación de los nuevos términos.
              </p>
            </section>
